...
function(CreateExportedFunctionsForEMSDK OUTPUT_VARIABLE)
	message(STATUS "CreateExportedFunctionsForEMSDK: ARGN is \"${ARGN}\"")
	if("${ARGN}" STREQUAL "")
		message(FATAL_ERROR "CreateExportedFunctionsForEMSDK: No arguments passed.")
	endif()
	set(result "")
	foreach(_name IN ITEMS ${ARGN})
		...
		set(result "${result}\"_${_name}\"") # Append and prepend leading underscore.
	endforeach()
	set(result "[${result}]")
	message(STATUS "CreateExportedFunctionsForEMSDK: ${result}")
